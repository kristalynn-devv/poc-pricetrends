...
defineRouteMeta({
  openAPI: {
    tags: ['Batch Search'],
    summary: 'Search thaprachan.com',
    description: 'Scrapes a thaprachan.com listing page for query, screenshots + Gemini-extracts each matching item, and persists successes immediately to output/results/ + output/logs/. หมวด (categoryId): 106. Response is a stream of NDJSON lines (application/x-ndjson).',
    requestBody: {
      required: true,
      content: {
        'application/json': {
